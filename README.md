...
| Gemini 3.8 Flash      | $0.75       | $3.75        | Released Sep 2, 2026; intro pricing through Dec 31, 2026 (doubles Jan 1, 2027).                                                |
...
**Tokenizer note (Anthropic):** Claude Opus 4.7+, Sonnet 5, Opus 5, Fable 5, and Fable 5.1 use a newer tokenizer that produces roughly 30% more tokens for the same text; per-token prices are unchanged, so the effective cost of a fixed input rises proportionally (Sonnet 4.6 and earlier keep the previous tokenizer). Benchmark your real workload before assuming a newer model lowers cost — confirmed on Anthropic's official pricing docs (already linked under Provider Pricing Pages above).
...
| [SeqRoute](https://arxiv.org/abs/2605.25424)                        | 2026 | Multi-turn routing as finite-horizon MDP via Conservative Q-Learning; reserves budget for high-stakes later turns, avoiding myopic overspend |
...
| [Token-Efficient Data Reasoning](https://arxiv.org/abs/2608.31082)         | 2026 | Pre-structured data is 28× cheaper than unstructured reasoning; adaptive on-demand structuring cuts per-question cost 53%          |
...
| [S⁴R](https://arxiv.org/abs/2608.00528)                              | 2026 | KV cache compression via selective sampling + low-rank SVD subspaces + sparse reconstruction; stores KV states as compact coefficients       |
| [QEvict](https://arxiv.org/abs/2608.05326)                           | 2026 | Recoverable quantized KV eviction for attention-drift-robust decoding; three-tier (full/quantized/evicted) management with drift diagnostics |
| [Strong Drafts, Compact Memories](https://arxiv.org/abs/2608.30252)  | 2026 | Memory-augmented drafter with compressed draft-side KV; 70%+ draft memory reduction; 2.08× on 8B, 3.33× on 70B at 32K prefix (EMNLP 2026)    |
...
| [ReCo](https://arxiv.org/abs/2608.04771)                            | 2026 | Reward-coordinated KV compression + reflection penalty + early stopping; 37–65% fewer tokens, 2.08–2.35× lower latency vs full CoT |
