...
- [DeepSeek KV Cache](https://api-docs.deepseek.com/guides/kv_cache) - Disk-based, 64-token granularity. V4 Flash cache hits: $0.0028/M vs $0.14/M base (98% savings). **Migration:** `deepseek-chat` and `deepseek-reasoner` aliases retired July 24, 2026 — update to `deepseek-v4-flash` or `deepseek-v4-pro`.
...
- [tokscale](https://github.com/junhoyeo/tokscale) - CLI and TUI dashboard tracking token usage and cost across 40+ AI coding agents (Claude Code, Cursor, OpenCode, and more) with global leaderboards and contribution heatmaps; native Rust, runs via `npx tokscale`. ![Stars](https://img.shields.io/github/stars/junhoyeo/tokscale)
...
| Claude Opus 5         | $5.00       | $25.00       | Released July 24, 2026; effort-toggle (low/medium/high) for capability vs. cost; 1M context.                                                 |
...
| GPT-5.6 Sol           | $5.00       | $30.00       | OpenAI flagship; 1.05M context; Fast Mode at 2.5× speed (2× rate); 90% cached-input discount; launched July 9, 2026.                         |
| GPT-5.6 Terra         | $2.00       | $12.00       | Balanced production tier; launched July 9, price cut 20% on July 30; 50% Batch discount.                                                     |
| GPT-5.6 Luna          | $0.20       | $1.20        | Budget tier; launched July 9, price cut 80% on July 30; lowest-cost OpenAI option.                                                           |
| DeepSeek V4 Flash     | $0.14       | $0.28        | Cheapest frontier; 98% cache savings; re-trained July 31, 2026.                                                                              |
| DeepSeek V4 Pro       | $0.435      | $0.87        | 1M context; thinking + non-thinking modes                                                                                                    |
| Gemini 3.1 Pro        | $2.00       | $12.00       | ≤200K context; doubles to $4/$18 above 200K tokens                                                                                           |
| Gemini 3.6 Flash      | $1.50       | $7.50        | Launched July 21, 2026; replaces 3.5 Flash; 17% output-cost reduction; 1M context.                                                           |
| Gemini 3.5 Flash-Lite | $0.30       | $2.50        | Launched July 21, 2026; high-volume budget tier; 350 tokens/s.                                                                               |
| Gemini 2.5 Flash-Lite | $0.10       | $0.40        | Legacy budget option                                                                                                                         |
| Grok 4.5              | $2.00       | $6.00        | xAI flagship; 500K context; 75% cached-input discount ($0.50/M on cache hits); launched July 8, 2026.                                        |

**Tokenizer note (Anthropic):** Claude Opus 5, Opus 4.8, Opus 4.7, Sonnet 5, and Fable 5 use a newer tokenizer that produces roughly 30% more tokens for the same text; per-token prices are unchanged, so the effective cost of a fixed input rises proportionally (Sonnet 4.6 and earlier keep the previous tokenizer). Benchmark your real workload before assuming a newer model lowers cost — confirmed on Anthropic's official pricing docs (already linked under Provider Pricing Pages above).
...
| [Activation Aggregation](https://arxiv.org/abs/2607.08399)         | 2026 | Replaces full input tokens with a learned weighted-sum activation vector; under 2% accuracy drop              |
...
| [Cluster, Route, Escalate](https://arxiv.org/abs/2606.27457)        | 2026 | Two-stage cascade (clustering + quality escalation) retains 97–99% of frontier accuracy at lower cost            |
...
| [EcoSpec](https://arxiv.org/abs/2607.12696)                          | 2026 | Cost-aware speculative decoding for MoE; avoids expert scattering by factoring in marginal expert activation cost; up to 1.62× speedup |
| [MosaicKV](https://arxiv.org/abs/2607.00760)                         | 2026 | Dynamic 2D KV cache compression (sequence + channel dimensions); avoids accuracy loss of single-axis approaches on long contexts       |
| [KVpop](https://arxiv.org/abs/2607.05061)                            | 2026 | Delayed memory-based scorer for online KV eviction; 98% of full-attention performance at 75% KV compression on Qwen3-4B                |
...
| [ETR](https://arxiv.org/abs/2604.05355)                             | 2026 | Entropy Trend Reward for efficient CoT; +9.9% accuracy, −67% length on DeepSeek-R1-Distill-7B (ACL 2026) |
