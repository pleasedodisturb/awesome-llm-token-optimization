...
| Gemini 3.6 Flash      | $1.50       | $7.50        | Launched July 21, 2026; 1M context; ~17% fewer output tokens vs 3.5 Flash; output price cut from $9.00.                                      |
...
| [SeqRoute](https://arxiv.org/abs/2605.25424)                        | 2026 | Budget-aware sequential routing via offline RL; treats multi-turn sessions as an MDP to prevent "budget bankruptcy" and preserve resources for high-stakes turns |
