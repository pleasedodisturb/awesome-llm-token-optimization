...
- [LLMeter](https://github.com/amedinat/LLMeter) - Open-source LLM cost monitoring with per-customer cost attribution. Polls provider billing/usage APIs (OpenAI, Anthropic, DeepSeek, OpenRouter) directly — no proxy, no SDK, no code changes — and alerts before surprise bills. ![Stars](https://img.shields.io/github/stars/amedinat/LLMeter)
