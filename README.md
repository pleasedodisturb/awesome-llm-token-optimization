...
- [snip](https://github.com/edouard-claude/snip) - Single-binary Go CLI proxy that filters shell output before it reaches a coding agent's context (60-90% fewer tokens), with 132 filters defined as declarative YAML data instead of compiled code; native hooks for Claude Code, Cursor, Copilot, Codex, Gemini CLI, and 8 more agents. ![Stars](https://img.shields.io/github/stars/edouard-claude/snip)
