...
- [traceburn](https://github.com/TommyTranX/traceburn) - Local-first tracer for AI agents; finds and quantifies wasted LLM spend (duplicate calls, missed caching, context bloat, model overkill, retries) and prints a mechanical fix for two of the five patterns. ![Stars](https://img.shields.io/github/stars/TommyTranX/traceburn)
