...
- [Agent Cost Auditor](https://github.com/zac343/agent-cost-auditor) - Dependency-free local CLI and browser audit for Codex, Claude Code, OpenClaw, Gemini, OpenRouter, and Vercel AI Gateway exports; flags replay, background, failure, fallback, and cache-related spend without uploading raw logs. ![Stars](https://img.shields.io/github/stars/zac343/agent-cost-auditor)
